...
It should be about 1.5 to 2 pages long, double-spaced, Times New Roman, 12 font. **Do** give it a title related to the topic, but do **not** include a header called *Introduction*. The introduction in an APA paper doesn't have a header.^[The first main header comes under *Method*] 
