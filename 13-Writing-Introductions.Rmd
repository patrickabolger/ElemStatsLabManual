...
```{block, type="rmdnote"}
***NOTE***: This topic is a random suggestion. You can choose any topic to write on as a lab. However, everyone in the lab should agree upon the topic. Avoid uncomfortable topics that might make some students feel both uncomfortable and  unwilling to let everyone know that they're uncomfortable with it. The topic should be quite benign. Your TA will act as a consultant here.
```
