...
<!-- Check to see if I included the part about including stats in the Design & Analysis part of Methods -->
...
Whatever may lie ahead in the *General Discussion*,^[or *Discussion* in a single-study paper] one thing will always come first: Namely, the authors will summarize the previous *Results* and *Discussion* sections into one summary, usually in one somewhat concise paragraph.
