...
```{r VisualizationsDotPlainTemp, fig.cap="A stacked dot plot within a violin plot.", echo=F, out.width="600px"}
knitr::include_graphics("images/DataVis/Visualizations_temp_HarpoViolinWithDots.png")
```
...
```{r VisualizationsDotPlainTemp2, fig.cap="A jittered dot plot and box plot within a violin plot.", echo=F, out.width="600px"}
knitr::include_graphics("images/DataVis/Visualizations_temp_HarpoViolinWithDots2.png")
```
