...
- book.bib
- packages.bib
description: 'This is a lab manual for PSYC 301: Elementary Statistics for Psychology.
  It is an open educational resource (OER), so there is no charge to students.'
documentclass: book
...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'haven', 'dplyr', 'magrittr', 'kableExtra', 'jmv', 'ggplot2'
  ), 
'packages.bib')
```
